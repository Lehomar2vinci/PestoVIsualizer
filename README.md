...
This project is an interactive audio visualizer using the [p5.js](https://p5js.org/) library to create dynamic visualizations based on microphone input.
...
1. Open **listener.html** in your browser.  
2. Use the on-screen controls to adjust sensitivity, select a color palette, and enable particles.  
3. Click **“Start”** to activate microphone input and begin visualization.
...
For more help, consult the [p5.js documentation](https://p5js.org/get-started/) or the [p5.sound.js docs](https://p5js.org/reference/#/libraries/p5.sound).
...
### Dependencies
- **[p5.js](https://p5js.org/)**: A JavaScript library for creative coding and interactivity.  
- **[p5.sound.js](https://p5js.org/reference/#/libraries/p5.sound)**: An extension of p5.js for handling sound input and analysis.
...
Ce projet est un visualiseur audio interactif utilisant la bibliothèque [p5.js](https://p5js.org/) pour créer des visualisations dynamiques basées sur l’entrée audio du microphone.
...
1. Ouvrez **listener.html** dans votre navigateur.  
2. Utilisez les contrôles à l’écran pour ajuster la sensibilité, sélectionner une palette de couleurs et activer les particules.  
3. Cliquez sur **« Démarrer »** pour activer l’entrée microphone et lancer la visualisation.
...
Pour plus d’aide, consultez la [documentation p5.js](https://p5js.org/get-started/) ou la [documentation de p5.sound.js](https://p5js.org/reference/#/libraries/p5.sound).
...
### Dépendances
- **[p5.js](https://p5js.org/)** : Une bibliothèque JavaScript pour la création interactive.  
- **[p5.sound.js](https://p5js.org/reference/#/libraries/p5.sound)** : Une extension de p5.js pour la gestion et l’analyse du son.
...
Este proyecto es un visualizador de audio interactivo que utiliza la biblioteca [p5.js](https://p5js.org/) para crear visualizaciones dinámicas basadas en la entrada de audio del micrófono.
...
1. Abre **listener.html** en tu navegador.  
2. Utiliza los controles en pantalla para ajustar la sensibilidad, seleccionar la paleta de colores y habilitar las partículas.  
3. Haz clic en **"Iniciar"** para activar la entrada del micrófono y comenzar la visualización.
...
Para más ayuda, consulta la [documentación de p5.js](https://p5js.org/get-started/) o la [documentación de p5.sound.js](https://p5js.org/reference/#/libraries/p5.sound).
...
### Dependencias
- **[p5.js](https://p5js.org/)**: Una biblioteca de JavaScript para la creación e interactividad.  
- **[p5.sound.js](https://p5js.org/reference/#/libraries/p5.sound)**: Una extensión de p5.js para manejar el sonido y su análisis.
...
Este projeto é um visualizador de áudio interativo que usa a biblioteca [p5.js](https://p5js.org/) para criar visualizações dinâmicas com base na entrada de áudio do microfone.
...
1. Abra o arquivo **listener.html** no seu navegador.  
2. Use os controles na tela para ajustar a sensibilidade, selecionar uma paleta de cores e ativar partículas.  
3. Clique em **"Iniciar"** para ativar a entrada do microfone e começar a visualização.
...
Para mais ajuda, consulte a [documentação do p5.js](https://p5js.org/get-started/) ou a [documentação do p5.sound.js](https://p5js.org/reference/#/libraries/p5.sound).
...
### Dependências
- **[p5.js](https://p5js.org/)**: Uma biblioteca JavaScript para criação e interatividade.  
- **[p5.sound.js](https://p5js.org/reference/#/libraries/p5.sound)**: Uma extensão do p5.js para manipulação e análise de som.
...
このプロジェクトは、[p5.js](https://p5js.org/) ライブラリを使用して、マイク入力に基づく動的なビジュアライゼーションを作成するインタラクティブなオーディオビジュアライザーです。
...
1. **listener.html** をブラウザで開きます。  
2. 画面上のコントロールを使って感度を調整したり、カラーパレットを選択したり、パーティクルを有効にしたりします。  
3. **「開始」** ボタンをクリックしてマイク入力を有効にし、ビジュアライゼーションを開始します。
...
詳細は [p5.js のドキュメント](https://p5js.org/get-started/) または [p5.sound.js のドキュメント](https://p5js.org/reference/#/libraries/p5.sound) を参照してください。
...
### 依存関係
- **[p5.js](https://p5js.org/)**: クリエイティブコーディングとインタラクティブな表現のための JavaScript ライブラリ。  
- **[p5.sound.js](https://p5js.org/reference/#/libraries/p5.sound)**: p5.js の拡張ライブラリで、サウンド入力と分析を扱うためのもの。

### コントリビュート（貢献）
貢献は歓迎です！Issue を立てたり、Pull Request を送ったりしてください。

### ライセンス
このプロジェクトは **MIT ライセンス**のもとで公開されています。詳細は [LICENSE](LICENSE) ファイルを参照してください。
...
本项目是一个使用 [p5.js](https://p5js.org/) 库的交互式音频可视化器，可根据麦克风输入创建动态可视化效果。
...
1. 在浏览器中打开 **listener.html**。  
2. 利用界面上的控件来调整敏感度、选择颜色调色板以及启用粒子效果。  
3. 点击 **“开始”** 以启用麦克风输入并开始可视化。
...
如需更多帮助，请参阅 [p5.js 文档](https://p5js.org/get-started/) 或 [p5.sound.js 文档](https://p5js.org/reference/#/libraries/p5.sound)。
...
### 依赖
- **[p5.js](https://p5js.org/)**：一个用于创意编程和互动艺术的 JavaScript 库。  
- **[p5.sound.js](https://p5js.org/reference/#/libraries/p5.sound)**：p5.js 的扩展库，用于处理声音输入和分析。

### 贡献
欢迎任何形式的贡献！请随时提交 issue 或 pull request。

### 许可证
本项目基于 **MIT 许可证**。有关更多细节，请参阅 [LICENSE](LICENSE) 文件。
